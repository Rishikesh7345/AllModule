...
class SetData implements ResolverInterface
{
    ...
    public function resolve(
        ...
        $tableName = $resource->getTableName('Test'); //gives table name with prefix
    
        $sql = "Insert Into " . $tableName . " (name, price, sku) Values ('test','200','test4')";

        $connection->query($sql);die;
