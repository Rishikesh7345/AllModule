...
class Button extends Template
{
    ...
    public function getProductCollection()
    {
        ...
        // $collection->addAttributeToFilter('color', array('red'));
        // $collection->addAttributeToFilter('capacityFrom', array('ls' => 0, 'gt' => 9));
        // $collection->addAttributeToFilter('capacityTo', array('gt' => 9, 'ls' => 1000));

        // $collection->addAttributeToFilter('height', array('in' => [0,12]));
        // // $collection->addAttributeToFilter('width', array('in' => [12,1000]));

        // foreach($collection as $con){
           
        //     echo $con->getCapacityTo();
        //     echo $con->getHeight();
        // }
